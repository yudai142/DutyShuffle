...
CREATE INDEX history_work_id_idx ON history (work_id);
CREATE INDEX history_member_id_idx ON history (member_id);
CREATE INDEX member_option_work_id_idx ON member_option (work_id);
CREATE INDEX member_option_member_id_idx ON member_option (member_id);
CREATE INDEX off_work_work_id_idx ON off_work (work_id);

--
-- ダンプしたテーブルのシーケンス初期値設定
--

SELECT setval('history_id_seq', 3, false);
SELECT setval('member_id_seq', 28, false);
SELECT setval('member_option_id_seq', 1, false);
SELECT setval('off_work_id_seq', 1, false);
SELECT setval('shuffle_option_id_seq', 1, false);
SELECT setval('work_id_seq', 11, false);
